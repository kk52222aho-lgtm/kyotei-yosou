...
# 3連単 点数×効率カーブ（test_trifecta_points: 妙味3,612R・確定払戻）。効率ピーク=3点。
TRIFECTA_CURVE = {
    "note": "3連単・妙味(本命≠1号)・クリーン年3,612R・確定払戻。効率(回収率)ピーク=3点(533%)／総額ピーク=50点(+1,835万)。",
    "points": [1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 18, 20, 24, 30, 40, 50, 60, 80, 100, 120],
    "roi": [432, 486, 533, 514, 532, 510, 431, 400, 367, 340, 320, 319, 304, 268, 227, 202, 180, 140, 115, 99],
    "hit": [8, 15, 21, 26, 30, 34, 40, 46, 51, 57, 63, 67, 72, 79, 86, 91, 95, 97, 99, 100],
    "pl": [1200660, 2788220, 4693000, 5983880, 7797020, 8876240, 9570140, 10839790, 11583350,
           12997200, 14310970, 15847290, 17715850, 18213480, 18277560, 18354820, 17250020,
           11423050, 5577670, -286510],
    "manshu": [35, 80, 118, 145, 180, 214, 251, 283, 313, 368, 411, 448, 501, 562, 649, 731, 798, 842, 880, 905],
}
