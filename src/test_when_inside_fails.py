"""「2番目の答え」= イン(#1)が負けた時、勝者を決めてるのは何か。

#1=イン55%勝ちのmetric内で#2を足しても埋もれる(全部~0)。∴切り方を変える:
インthaが勝たなかったレース(=位置の下駄が消えた世界)だけに絞り、非イン勝者を
当てる力を選抜器ごとに比較する。一番当てる軸=位置が崩れた時の王様=真の第二の答え。
...
def main():
    ...
    print("\n読み: 一番当てる軸が『イン(#1)が崩れた時の王様』=2番目の答え。")
    print("      2号ベタ/モデルを明確に超える軸が出れば、それが位置の次に効く本物の力。")
