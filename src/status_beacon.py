...
TABLES = [
    ...
    ("odds_timeseries", 2),
    ("kachimake", 14),
    # 🚨 2026-09-24: oriten は 14 → 3 に締めた。24場が毎日開催しとるんで、
    #   正常なら常に1〜2日以内に入る。**今回の8日の取りこぼしは14日やと
    #   そもそも鳴らん**設定やった(403を「不在」と刻んで済み扱いにしとった件)。
    #   門は在ったが目盛りが粗すぎた。→ [[insight_zero_is_a_measurement]]
    ("oriten", 3),
]
